...
<p className="note"> Please leave a note and I will get back to you within 48 hours.</p>
...
<textarea className="messageholder" placeholder="Message" cols="50" rows="20"></textarea>
<div>
